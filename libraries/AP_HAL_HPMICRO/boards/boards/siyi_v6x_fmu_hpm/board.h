...
#define BOARD_APP_SDCARD_CARD_DETECTION_PIN     IOC_PAD_PE18
...
#define BOARD_APP_EMMC_SUPPORT_POWER_SWITCH    (0)
#define BOARD_APP_EMMC_POWER_SWITCH_USING_GPIO (0)
...
#define BOARD_APP_EMMC_POWER_SWITCH_PIN     IOC_PAD_PE18
...
#define BOARD_APP_SDCARD_CARD_DETECTION_GPIO_INDEX GPIO_DI_GPIOE
#define BOARD_APP_SDCARD_CARD_DETECTION_PIN_INDEX  18
#endif
...
#define BOARD_APP_PWM_CLOCK_NAME  clock_mot1
#define BOARD_APP_PWM_OUT1        6
#define BOARD_APP_PWM_OUT2        7
#define BOARD_APP_TRGM            HPM_TRGM1
